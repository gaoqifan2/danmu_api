...
const DEFAULT_VOD_SERVERS = "金蝉@https://zy.jinchancaiji.com,vod@https://www.caiji.cyou"; // 默认 vod站点配置，格式：名称@URL,名称@URL
let vodServers = [];
...
const DEFAULT_SOURCE_ORDER = "金蝉,vod,360,tencent,renren,hanjutv"; // 默认 源排序（不包含tencent，需要时请通过SOURCE_ORDER环境变量添加）
let sourceOrderArr = [];
...
function resolveSourceOrder(env, deployPlatform) {
  ...
  const allowedSources = ['jinchan','360', 'vod', "tencent", 'renren', "hanjutv", "bahamut"];
